...
(function() {
  ...
  root.Fractal = (function() {
    function Fractal(selector, fragment, bg) {
      var $canvas;
      if (bg == null) {
        bg = [0, 0, 0, 0];
      }
    ...
    Fractal.prototype.updateFragment = function(fragment) {
      this.fragment = fragment || [[1]];
      return this.params.size = this.fragment.length;
    };

    Fractal.prototype.getBlob = function(type, callback) {
      if (type == null) {
        type = 'image/png';
      }
      return this.canvas.toBlob(callback, type);
    };
    ...
    Fractal.prototype.draw = function(callback) {
      ...
      call = function(i) {
        ...
        return fractal._drawTO = setTimeout(function() {
          return fractal.iteration(0, iterations[i], iterations, function() {
            ...
            if (count <= 0) {
              return typeof callback === "function" ? callback(fractal.canvas) : void 0;
            }
          });
        }, 0);
      };
    ...
    Fractal.prototype.stop = function() {
      if (this._drawTO) {
        clearTimeout(this._drawTO);
      }
      if (this._iterateTO) {
        return clearTimeout(this._iterateTO);
      }
    };
    ...
    Fractal.prototype.iteration = function(i, iteration, iterations, callback) {
      ...
      fractal = this;
      return fractal._iterateTO = setTimeout(function() {
        var j;
        j = 0;
      ...
      for (i = k = 0, len = ref.length; k < len; i = ++k) {
        ...
        results.push((function() {
          ...
          for (j = l = 0, len1 = column.length; l < len1; j = ++l) {
            ...
            results1.push(this.ctx.fillRect(iX * iSize + j * pointSize, iY * iSize + i * pointSize, pointSize, pointSize));
          }
          return results1;
        }).call(this));
      }
